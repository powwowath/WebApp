...
public class RouteCandidateController {
    ...
    public List<RouteCandidate> rc (@RequestParam(value="departureCity") String dep, @RequestParam(value="destinationCity") String dest, @RequestParam(value="steps", defaultValue="3") int steps) {
...
//        List<RouteCandidate> rc = routeCandidateRepository.querySearch(query);
/*
  ...
  */
        ...
        return IteratorUtils.toList(routeCandidateRepository.cypherQuery(dep, dest, steps).iterator());
